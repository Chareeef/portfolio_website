...
import { 
  SiHtml5, SiCss3, SiJavascript, SiNodedotjs, SiNextdotjs, SiReact, 
  SiTailwindcss, SiExpress, SiPython, SiDjango, SiFlask,
...
const ContinuousFeed = ({ skills }: { skills: { name: string; icon: React.ElementType }[] }) => {
...
const CircularOrbit = ({ skills }: { skills: { name: string; icon: React.ElementType }[] }) => {
...
const HeartbeatingSquare = ({ skills }: { skills: { name: string; icon: React.ElementType }[] }) => {
    ...
    <section id="skills" className="py-20">
      ...
      <div className="space-y-12">
        <div className="bg-white/5 dark:bg-black/5 backdrop-blur-md rounded-lg p-6">
          <h3 className="text-2xl font-bold mb-4 text-center">{skillSections[0].title}</h3>
          <ContinuousFeed skills={skillSections[0].skills} />
        </div>
        <div className="bg-white/5 dark:bg-black/5 backdrop-blur-md rounded-lg p-6">
          <h3 className="text-2xl font-bold mb-4 text-center">{skillSections[1].title}</h3>
          <CircularOrbit skills={skillSections[1].skills} />
        </div>
        <div className="bg-white/5 dark:bg-black/5 backdrop-blur-md rounded-lg p-6">
          <h3 className="text-2xl font-bold mb-4 text-center">{skillSections[2].title}</h3>
