  ...
  en: {
    ...
    projects: {
      ...
      archiveDescriptions: [
        ...
        "A Solana copy-trading bot that monitored selected wallets in real time, reconstructed swaps across Pump.fun, Raydium, Meteora and Jupiter, and combined low-latency transaction delivery with automated exits.",
  ...
  fr: {
    ...
    navigation: {
      ...
      otherProjectItems: [
        ...
        ["Sadim AI", "#sadim-ai"],
        ["CodeLog", "#codelog"],
        ["Bot de copy-trading Solana", "#solana-copy-trading-bot"],
        ["Hayat", "#hayat"],
        ["Simple Shell", "#simple-shell"],
      ],
      items: [
    ...
    projects: {
      ...
      archiveDescriptions: [
        ...
        "Un bot de copy-trading sur Solana qui suivait en temps réel des portefeuilles sélectionnés, reconstruisait les swaps sur Pump.fun, Raydium, Meteora et Jupiter, et combinait une diffusion de transactions à faible latence avec des sorties automatisées.",
